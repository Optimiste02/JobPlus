...
public class AdapterMesPublications extends  RecyclerView.Adapter<ListViewHolder>{
    //Les Variables.............
    Context context;
    List<Model> AllData;
    int IdLogged= 3;
    ...
    // Constructeur ..........................
    public AdapterMesPublications(List<Model> GetAllData, Context context){
        super();
    ...
    public ListViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.mes_publications, parent, false);
    ...
    public void onBindViewHolder(final ListViewHolder listViewHolder, final int position) {
        ...
        listViewHolder.Poste.setText(AllData.get(position).getPoste());
